...
**Перед настройкой TypeScript, ESLint и Tailwind создай минимальные файлы для React Router:**

👉 **[REACT_ROUTER_SETUP.md](./REACT_ROUTER_SETUP.md)** - Создание обязательных файлов

Эти файлы нужны для запуска dev сервера. Без них будут ошибки.
