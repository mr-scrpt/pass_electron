 ...
 * 
 * @example
 * // Electron config (расширение через Decorator):
 * const webDisplay = new SonnerNotificationDisplay()
 * const enhanced = new ElectronNotificationDecorator(webDisplay)
