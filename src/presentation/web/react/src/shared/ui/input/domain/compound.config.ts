...
export const inputCompoundStateMapping = {
  ...
  [INPUT_VIEW.OUTLINE]: {
    [INPUT_STATE.IDLE]: INPUT_COMPOUND_STATE.OUTLINE_IDLE,
    [INPUT_STATE.ERROR]: INPUT_COMPOUND_STATE.OUTLINE_ERROR,
    [INPUT_STATE.SUCCESS]: INPUT_COMPOUND_STATE.OUTLINE_SUCCESS,
    [INPUT_STATE.WARNING]: INPUT_COMPOUND_STATE.OUTLINE_WARNING,
  },
} satisfies Record<
  InputViewType,
